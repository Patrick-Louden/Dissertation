...
XXX add a figure highlighting the different surface corrugations and
featuers, maybe some dimensions of the surface features as well as the
surface energies. XXX 
...
Forcefield parameters for both water models can be found in table
\ref{tab:waterModels}. 
