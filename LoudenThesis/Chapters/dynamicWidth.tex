...
\begin{equation}\label{trasport1}
...
\begin{equation}\label{trasport2}
...
dimensions. From Eq. \eqref{transport1} and Eq. \eqref{transport2},
...
structural widths obtained in Chapter \ref{chap:Struct}. 

For each of the ice-I$_\mathrm{h}$ / water interfaces described in
Chapter \ref{chap:Struct}, four subsequent one nanosecond simulations
...
In the top panel of Figure \ref{fig:Diffuzionz}, the mean-squared
displacement has been computed of molecules within 1 \AA~ bins across
the SPC/E basal ice / water interface.
