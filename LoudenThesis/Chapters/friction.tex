...
Fig. \ref{Fig:SPCEjumpRates}. By querying the value of
$k_\mathrm{jump}$ at the interface, we have obtained estimates of the
hydrogen bond lifetime for each of the crystal facets, which are
reported in Table \ref{tab:jumpRates}.


\begin{table}[h]
\centering
\caption{HYDROGEN BOND JUMP RATES ($k_\mathrm{jump}$) FOR ICE-I$_\mathrm{h}$ / WATER INTERFACES.\label{tab:jumpRates}}
\begin{tabular}{|r|cc|cc|}  
\toprule
