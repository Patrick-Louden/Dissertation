...
coefficients, leading to the conclusion that friction is dominated by
...
\begin{tablenotes}
      \small
    \item Friction coefficients are measured in
...
discriminate liquid-like and ice-like water molecules more accurately
...
\begin{tablenotes}
      \small
    \item Friction coefficients $\kappa$ are measured in amu
      \AA\textsuperscript{-2} fs\textsuperscript{-1}, and
...
\begin{tablenotes}
      \small
    \item Hydrogen bond lifetimes $\tau_{\mathrm{HB}}$ (in ps)
      measured at the structural interface (as determined by
      tetrahedrality) and at the dynamic interface (as measured by
...
water interfaces have significantly shorter lived hydrogen bonds, with
