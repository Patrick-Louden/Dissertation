...
\section{Driving Forces for Interfacial Friction}
...
\caption{HYDROGEN BOND LIFETIMES  ($k_\mathrm{jump}^{-1}$) FOR
  ICE-I$_\mathrm{h}$ / WATER INTERFACES.(Measured in ps)\label{tab:jumpRates}}
\begin{tabular}{|r|cc|cc|}  
\toprule
...
Pyramidal  $\{20\bar{2}1\}$       & 500 & 100   & 125 & 50\\
Secondary Prism  $\{11\bar{2}0\}$ & 333 &111  & 100 & 50\\ 
\bottomrule
\end{tabular}
\end{table}

We find that hydrogen bonds at the SPC/E ice-I$_\mathrm{h}$ / water
interface has a lifetime of $\sim$ 100 ps, and $\sim$ 50 ps for
TIP4P/Ice ice-I$_\mathrm{h}$ / water interfaces. For all interfaces,
the hydrogen bond lifetime is observed to be longer-lived in the SPC/E
interfaces as compared to the TIP4P/Ice interfaces. This is primarily
due to the warmer coexistence temperature for the TIP4P/Ice model,
leading to faster dynamics of the water molecules. However, there is
no observed trend in the lifetime of the hydrogen bonds with the
observed friction, further indicating that friction at
ice-I$_\mathrm{h}$ / water interfaces is governed by the density of
...
% these differences have been less clear.\cite{Beaglehole1993}
