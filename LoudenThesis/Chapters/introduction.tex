...
We begin by considering a many-body expansion of the a configurational
potential energy $\mathscr{U}$ for a collection of $N$ particles.
\begin{equation}\label{eq:potE}
\mathscr{U}(\mathbf{r}^N) = \sum_i U(r_i) + \sum_{i<j} U(r_i,r_j) + \sum_{i<j<k}
U(r_i,r_j,r_k) \dots + U(r_1,r_2,r_3,\dots r_N)
\end{equation}
...
particles, therefore from our truncated expansion we can obtain the
force on particle $i$.
