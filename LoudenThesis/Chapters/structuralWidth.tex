...
from the density profiles (black lines) and hyperbolic tangent fits
(red dashed-lines) in Figure \ref{fig:transDensity} that an order
parameter that does not depend on the crystal orientation would give a
more accurate estimate of the ice-I$_\mathrm{h}$ / water interface.
