...
\hline
  Basal  $\{0001\}$                 & 7.1 & 7.5(4) & 8.1 & 8.8(8)  \\
  Prismatic  $\{10\bar{1}0\}$       & 4.5  & 7.2(2) & 9.2 & 9.0(5)  \\
  14\degree~Pyramidal  $\{20\bar{2}1\}$       & 2.0 & 6.6(2) & 4.6 & 8.2(5)  \\
  Secondary Prism  $\{11\bar{2}0\}$ & 4.9 &6.7(2) & 8.0 & 9.4(6)  \\ 
\hline
\end{tabular}
\flushleft
